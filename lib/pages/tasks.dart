              ...
              RaisedButton(
                ...
                onPressed: () {
                  if (formkey.currentState.validate()) {
                    ...
                    if (isUpdate) {
                      taskcollections.document(uid).collection('task').document(ds.documentID).updateData({
                        'task': task,
                        'time': DateTime.now(),
                      });
                    } else {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: StreamBuilder<QuerySnapshot>(
        stream: taskcollections.document(uid).collection('task').orderBy('time').snapshots(),
              ...
              itemBuilder: (context, index) {
                ...
                return Container(
                  ...
                  child: ListTile(
                    ...
                    onLongPress: () {
                      // delete
                      taskcollections.document(uid).collection('task').document(ds.documentID).delete();
                    },
                    onTap: () {
                      // == Update
                      showdialog(true, ds);
